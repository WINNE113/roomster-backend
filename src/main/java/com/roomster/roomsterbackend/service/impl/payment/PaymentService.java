        ...
        try {
            ...
            if(isValidSignature){
                ...
                if(payment.isPresent()){
                    ...
                    if(Objects.equals(payment.get().getRequiredAmount(), response.getVnp_Amount().divide(new BigDecimal(100)))){
                        ...
                        if(!Objects.equals(payment.get().getPaymentStatus(), "0")){
                            ...
                            if(Objects.equals(response.getVnp_ResponseCode(),"00") && Objects.equals(response.getVnp_TransactionStatus(),"00")){
                                ...
                                paymentTransactionRequestDb.setTranPayload(ConvertObjectToJsonExtension.convertToJson(response));
            ...
            if(Objects.equals(response.getPaymentStatus(),"00")){
                ...
                if(payment.isPresent()){
                    ...
                    if(user.isPresent()){
                        ...
                        BigDecimal newBalance = user.get().getBalance().add(payment.get().getRequiredAmount());
